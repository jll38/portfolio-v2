...
export default function Post({ postData }) {
  return (
    <>
      <div className="dark:bg-black absolute top-0 w-screen">
        <div className="fixed h-screen w-screen bg-gradient-to-t from-gray-400 to-white -z-10 dark:hidden top-0 "></div>
        <Head>
