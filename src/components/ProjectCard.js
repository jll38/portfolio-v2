...
export function ProjectCard({ title, img, link, ghLink, desc }) {
  return (
    <div className="w-[350px] sm:w-[425px]">
          ...
          <div class="truncate">
            <div class="text-center rounded  truncate">
              ...
              <Link href={link} class="cursor-pointer" target={"_blank"}>
                ...
                <img
                  src={img}
                  class="align-middle rounded overflow-clip object-cover h-[250px] w-[425px]"
